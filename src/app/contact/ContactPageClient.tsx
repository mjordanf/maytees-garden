  ...
  return (
    <div className="pt-20 bg-cream min-h-screen">
      ...
      <section className="bg-green-800 py-16 text-center">
        <h1 data-cms-key="contact.title" className="font-serif text-5xl font-bold text-white mb-3">{title}</h1>
        <p data-cms-key="contact.subtitle" className="text-green-200 text-lg max-w-lg mx-auto">{subtitle}</p>
      </section>
                  ...
                  {[
                    ...
                    <div key={title} className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p data-cms-key={cmsKey} className="text-sm text-gray-700 whitespace-pre-line">{text}</p>
                      </div>
                    </div>
                  ))}
                </div>
