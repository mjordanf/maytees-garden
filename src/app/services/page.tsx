      ...
      <section className="bg-green-800 py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4">
          <h1 data-cms-key="services.hero.headline"
            ...
            {c(content, 'services.hero.headline', 'Garden Services')}
          </h1>
          <p data-cms-key="services.hero.subtitle"
            className="text-green-200 text-xl leading-relaxed">
            {c(content, 'services.hero.subtitle', 'From first consultation to long-term care — everything your South Florida garden deserves.')}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 data-cms-key="services.process.title" className="section-title">
              {c(content, 'services.process.title', 'How It Works')}
            </h2>
            <p data-cms-key="services.process.subtitle" className="section-subtitle">
              {c(content, 'services.process.subtitle', 'From your first call to a thriving garden — a simple, four-step process.')}
            </p>
          </div>
      ...
      <section className="py-16 bg-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 data-cms-key="services.area.headline" className="font-serif text-3xl font-bold mb-4">
            {c(content, 'services.area.headline', 'Service Area')}
          </h2>
          <p data-cms-key="services.area.subtitle" className="text-green-200 mb-8">
            {c(content, 'services.area.subtitle', 'We serve residential and commercial clients across all of Miami-Dade County and parts of Broward County.')}
          </p>
