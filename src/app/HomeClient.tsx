      ...
      <section className="py-24 bg-gradient-to-br from-green-800 to-green-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
          <h2 data-cms-key="home.cta.headline" className="font-serif text-4xl md:text-5xl font-bold text-white mb-6">
            {FLAGS.SHOW_BOOKING ? c(content, 'home.cta.headline', 'Ready for Your Transformation?', lang) : "Ready to Transform Your Garden?"}
          </h2>
          <p data-cms-key="home.cta.subtext" className="text-green-200 text-lg mb-10 leading-relaxed">
            {FLAGS.SHOW_BOOKING ? c(content, 'home.cta.subtext', "Let Maytee design the garden you've always imagined. Book a consultation and get a personalized design proposal.", lang) : "Get in touch and let's talk."}
          </p>
