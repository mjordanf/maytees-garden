...
async function main() {
  const svc = await p.service.findFirst({ where: { nameEn: 'Ongoing Garden Maintenance' } })
  if (svc) {
    await p.service.update({ where: { id: svc.id }, data: { imageUrl: 'https://images.unsplash.com/photo-1558904541-efa843a96f01?auto=format&fit=crop&w=800&q=80' } })
  ...
  await p.galleryItem.createMany({ data: [
    ...
    { id:'g11', imageUrl:'/gallery/nursery-orchids-driftwood-display-1.jpg',        captionEn:'Orchid Display — Maytees Garden Center',           captionEs:'Exhibición de Orquídeas — Vivero',                 category:'commercial',  featured:false, sortOrder:11 },
    ...
    { id:'g21', imageUrl:'/gallery/nursery-bromeliads-sago-palm-1.jpg',             captionEn:'Maytees Garden Center — Plant Selection',          captionEs:'Centro de Jardín de Maytee — Selección de Plantas',category:'commercial',  featured:false, sortOrder:21 },
  ...
  console.log('23 real photos written to PostgreSQL')
  await p.$disconnect()
}
